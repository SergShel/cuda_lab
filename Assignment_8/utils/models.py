...
# inspiration taken from  https://github.com/milesial/Pytorch-UNet
...
class Up(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        x = torch.cat([x2, x1], dim=1)  # <----  concatenation with the skip connection
        return self.conv(x)
    
# UNet output convolution block
